...
@php
    ...
    // fallback aman kalau controller belum ngirim
    $leaveBalance = $leaveBalance ?? [
        'n2' => ['year' => now()->year - 2, 'remaining' => 12, 'bonus' => 6],
        'n1' => ['year' => now()->year - 1, 'remaining' => 12, 'bonus' => 6],
        'n'  => ['year' => now()->year,     'remaining' => 12, 'quota' => 12],
        'total_available' => 24,
    ];
@endphp
        ...
        <section class="bg-white rounded-3xl shadow-soft border border-slate-100 overflow-hidden">
            <div class="px-6 md:px-8 py-5 border-b border-slate-50 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs md:text-sm text-slate-500 font-medium">Ringkasan sisa cuti berdasarkan tahun (mengikuti approved).</p>
                </div>
            </div>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <tr>
                            ...
                            <td class="py-4 pr-4">
                                <input type="text" readonly value="{{ $leaveBalance['n2']['remaining'] ?? 0 }}"
                                       class="w-28 px-3 py-2 rounded-xl border border-slate-200 bg-slate-50 text-slate-700 font-semibold">
                            </td>
                            <td class="py-4">
                                <input type="text" readonly value="Bonus: {{ $leaveBalance['n2']['bonus'] ?? 0 }} hari (setengah dari sisa)"
                        ...
                        <tr>
                            ...
                            <td class="py-4 pr-4">
                                <input type="text" readonly value="{{ $leaveBalance['n1']['remaining'] ?? 0 }}"
                                       class="w-28 px-3 py-2 rounded-xl border border-slate-200 bg-slate-50 text-slate-700 font-semibold">
                            </td>
                            <td class="py-4">
                                <input type="text" readonly value="Bonus: {{ $leaveBalance['n1']['bonus'] ?? 0 }} hari (setengah dari sisa)"
                                       class="w-full px-3 py-2 rounded-xl border border-slate-200 bg-slate-50 text-slate-600 font-medium">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="py-4 pr-4">
                                <input type="text" readonly value="{{ $leaveBalance['n']['remaining'] ?? 0 }}"
                                       class="w-28 px-3 py-2 rounded-xl border border-slate-200 bg-slate-50 text-[var(--maroon)] font-extrabold">
                            </td>
                            <td class="py-4">
                                <input type="text" readonly value="Sisa cuti tahun ini (dari {{ $leaveBalance['n']['quota'] ?? 12 }} hari)"
                                       class="w-full px-3 py-2 rounded-xl border border-slate-200 bg-slate-50 text-slate-600 font-medium">
                            </td>
                        </tr>
                        ...
                        <tr class="bg-emerald-50/30">
                            ...
                            <td class="py-4 pr-4">
                                <input type="text" readonly value="{{ $leaveBalance['total_available'] ?? 0 }}"
                                       class="w-28 px-3 py-2 rounded-xl border border-emerald-200 bg-emerald-50 text-emerald-700 font-black">
                            </td>
                            <td class="py-4">
                                <input type="text" readonly value="Total cuti yang dapat diambil saat ini"
